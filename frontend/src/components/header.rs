                ...
                {move || if !is_editor_open.get() {
                    view! {
                        <div class="terminal-status-pill">
                            ...
                            <span class="terminal-status-text">"Terminal Ready"</span>
                        </div>

                        <div class="header-divider"></div>

                        <div class="header-hint">
                            <span class="hint-label">"Open file:"</span>
                            <code class="hint-code">"mdterm <file>"</code>
                            <span class="hint-sep">"or"</span>
                            <span class="hint-sub">"click filename in terminal"</span>
                        </div>
                        ...
                        <div class="action-btn-group">
                            <button
                                type="button"
                                class="header-btn"
                                title="New Markdown Document (Ctrl+N)"
            ...
            <div class="header-right">
                {move || if is_editor_open.get() {
                    view! {
                        <button
                            type="button"
                            class="header-btn close-editor-btn"
                            title="Close editor and switch to full-screen terminal (Ctrl+W)"
